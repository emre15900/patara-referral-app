      ...
      <DropdownMenuContent align="end" className="bg-zinc-900 border-zinc-800 text-white p-4 w-80">
        ...
        <div className="py-3 border-t border-b border-zinc-800 my-3">
          ...
          <p className="text-xs bg-zinc-950 p-2 rounded border border-zinc-800 truncate overflow-hidden">
            https://patara.io/ref/0x1a2b3c4d5e6f7g8h9i0j
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <Button variant="default" className="bg-blue-600 hover:bg-blue-700 text-white border-0 rounded-md">
            Dashboard
          </Button>
          <Button variant="outline" className="border-zinc-700 hover:bg-zinc-800 text-white rounded-md">
            Sign Out
          </Button>
        </div>
      </DropdownMenuContent>
